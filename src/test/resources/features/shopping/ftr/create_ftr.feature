@CLRegression
@Ftr
Feature: This feature covers tests to create Free Text Requisition and submit it

    Scenario: Raise a new Free text requisition
     ...
     #And On FTR edit page - I attach a file
      And On FTR edit page - I enter 'special Instructions' as 'Catfish instructions for FTR'
