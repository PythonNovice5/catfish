...
public class AgentAgreementPricelistItemPage extends ProductManagerPage
{
    ...
    public AgentAgreementPricelistItemPage()
    {
    ...
    public String getExpectedUrl() {
        return getBaseUrl() + "/products/agreementPriceList/index";
    }
    ...
    {
        waitUntillElementIsClickableAndClick(approveButton);
        waitUntillElementIsClickableAndClick(confirmApproval);
    }
}
